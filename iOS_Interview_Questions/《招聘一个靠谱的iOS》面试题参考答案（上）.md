...
![enter image description here](https://camo.githubusercontent.com/c1f8d683aac8a7e2c853aee261b7879d9de317eb/687474703a2f2f692e696d6775722e636f6d2f557756396f536e2e6a706567)

克强总理这样评价你的代码风格：

![enter image description here](https://camo.githubusercontent.com/0340c76bb7a97a27838f105905638a5ae4222e14/687474703a2f2f692e696d6775722e636f6d2f4e37374c6b69632e706e67)
...
### 7. @protocol 和 category 中如何使用 @property
 ...
 1. 在 protocol 中使用 `@property` 只会生成 setter 和 getter 方法声明。我们使用属性的目的，是希望遵守协议的对象能实现该属性。
...
### 11. @synthesize和@dynamic分别有什么作用？
 ...
 2. @synthesize 的语义是：如果你没有手动实现 setter 方法和 getter 方法，那么编译器会自动为你加上这两个方法。
...
在非集合类对象中：
1. ==对 immutable 对象进行 copy 操作，是指针复制，mutableCopy 操作时内容复制==；
...
2. ==对 mutable 对象进行 copy 和 mutableCopy 都是内容复制。但是：集合对象的内容复制仅限于对象本身，对象元素仍然是指针复制==。用代码简单表示如下：
...
正如 [Apple官方文档 ***You Can Customize Synthesized Instance Variable Names***](https://camo.githubusercontent.com/d562010accc0b123c355d48d56b4eb426b032641/687474703a2f2f692e696d6775722e636f6d2f443664307a474a2e706e67) 所说：

![](https://camo.githubusercontent.com/d562010accc0b123c355d48d56b4eb426b032641/687474703a2f2f692e696d6775722e636f6d2f443664307a474a2e706e67)
...
结果编译器报错：
![enter image description here](https://camo.githubusercontent.com/a569a90281598d8cc74156fe5f0e3a6ddbf8fc6b/687474703a2f2f692e696d6775722e636f6d2f6641454748496f2e706e67)
...
![enter image description here](https://camo.githubusercontent.com/bf346edc21ab4b3387906602249b357d250ab1c2/687474703a2f2f692e696d6775722e636f6d2f6541483559576e2e706e67)
...
每个 Objective-C 对象都有相同的结构，如下图所示：
 ...
 ![enter image description here](https://camo.githubusercontent.com/f446a82030de175ad18c7af85f097e1eea3fe496/687474703a2f2f692e696d6775722e636f6d2f376d4a6c556a312e706e67)
...
如图:
![enter image description here](https://camo.githubusercontent.com/cdc02fffae7a70aa00cbb6c0f3675d00728cdaad/687474703a2f2f692e696d6775722e636f6d2f7736747a46787a2e706e67)
