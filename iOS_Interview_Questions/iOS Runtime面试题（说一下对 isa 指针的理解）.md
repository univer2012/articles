来自：[iOS Runtime面试题（说一下对 isa 指针的理解）](https://juejin.im/post/5e7affd95188255e1901d0ac)
...
**问题：说一下对 `isa` 指针的理解， 对象的`isa` 指针指向哪里？`isa` 指针有哪两种类型？**
...
在Runtime源码查看 `isa_t` 是共用体。简化结构如下：
